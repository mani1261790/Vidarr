...
public struct GestureResult {
    ...
    public init(name: String, score: CGFloat) {
        self.name = name
        self.score = score
    }
}
...
public final class GestureRecognizer {
    ...
    public init(matchScoreThreshold: CGFloat = 0.75, minPathLength: CGFloat = 120, dominanceRatio: CGFloat = 2.0) {
        self.matchScoreThreshold = matchScoreThreshold
        self.minPathLength = minPathLength
        self.dominanceRatio = dominanceRatio
    }

    public func recognize(points raw: [CGPoint], allowedNames: Set<String>? = nil) -> GestureResult? {
    ...
    public func bestMatch(points raw: [CGPoint], allowedNames: Set<String>? = nil) -> GestureResult? {
    ...
    public func bestPassingMatch(points raw: [CGPoint], minimumScore: CGFloat, allowedNames: Set<String>? = nil) -> GestureResult? {
        guard raw.count >= 5 else { return nil }
