            ...
            if tabSwitchTransition == nil,
               ...
               nativeStartDismissalTabID != tab.id {
                PadNativeStartPageView(
                    ...
                    compact: true,
                    bottomBarClearance: tabStripHeight + bottomBarBottomPadding + 14,
                    ...
                    onDeleteBookmarkItem: { item in
                        model.removeBookmarkItems([item.id])
                    },
                    onClearHistory: {
                        model.removeHistoryItems(Set(model.allHistory().map(\.id)))
                    },
                    onClearBookmarks: {
